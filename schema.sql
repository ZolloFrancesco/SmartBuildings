...
CREATE TABLE IF NOT EXISTS `Rischio` (
  ...
  INDEX `fk_Rischio_AreaGeografica1_idx` (`AreaGeografica` ASC),
...
CREATE TABLE IF NOT EXISTS `Eventualita` (
  ...
  INDEX `fk_Edificio_has_Calamita_Calamita1_idx` (`AreaGeografica` ASC, `Data` ASC, `TipoCalamita` ASC),
  INDEX `fk_Edificio_has_Calamita_Edificio1_idx` (`Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `Pianta` (
  ...
  INDEX `fk_Pianta_Edificio1_idx` (`Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `Vano` (
  ...
  INDEX `fk_Vano_Pianta1_idx` (`Piano` ASC, `Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `Parte` (
  ...
  INDEX `fk_Parte_Vano1_idx` (`Vano` ASC, `Piano` ASC, `Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `Sensore` (
  ...
  INDEX `fk_Sensore_Parte1_idx` (`Parte` ASC, `Vano` ASC, `Piano` ASC, `Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `Operaio` (
  ...
  PRIMARY KEY (`CFisc`),
  INDEX `fk_Oparaio_Capocantiere1_idx` (`Capocantiere` ASC),
...
CREATE TABLE IF NOT EXISTS `Stadio` (
  ...
  INDEX `fk_Stadio_Progetto1_idx` (`CodProgetto` ASC),
...
CREATE TABLE IF NOT EXISTS `Lavoro` (
  ...
  `Responsabile` CHAR(5) NOT NULL,
  `DataInizioStadio` DATE NOT NULL,
  `CodProgetto` CHAR(5) NOT NULL,
  PRIMARY KEY (`CodLavoro`),
  INDEX `fk_Lavoro_Responsabile1_idx` (`Responsabile` ASC),
  INDEX `fk_Lavoro_Stadio1_idx` (`DataInizioStadio` ASC, `CodProgetto` ASC),
...
CREATE TABLE IF NOT EXISTS `Controllo` (
  ...
  INDEX `fk_Lavoro_has_Capocantiere_Capocantiere1_idx` (`Capocantiere` ASC),
  INDEX `fk_Lavoro_has_Capocantiere_Lavoro1_idx` (`CodLavoro` ASC),
...
CREATE TABLE IF NOT EXISTS `Turno` (
  `Data` DATE NOT NULL,
  `CFisc` CHAR(50) NOT NULL,
  `Orario` VARCHAR(11) NOT NULL,
  `DataInizioStadio` DATE NOT NULL,
  `CodProgetto` CHAR(5) NOT NULL,
  PRIMARY KEY (`Data`, `CFisc`, `Orario`),
  INDEX `fk_Turno_Stadio1_idx` (`DataInizioStadio` ASC, `CodProgetto` ASC),
...
CREATE TABLE IF NOT EXISTS `PuntoAccessoEsterno` (
  ...
  `Edificio` CHAR(5) NOT NULL,
  PRIMARY KEY (`IDPuntoAccesso`),
  INDEX `fk_PuntoAccessoEsterno_Vano1_idx` (`IDVano` ASC, `Piano` ASC, `Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `Accelerometro` (
  ...
  INDEX `fk_Accelerometro_Sensore1_idx` (`IDSensore` ASC),
...
CREATE TABLE IF NOT EXISTS `Giroscopio` (
  ...
  `IDSensore` CHAR(5) NOT NULL,
  PRIMARY KEY (`TimeStamp`, `IDSensore`),
  INDEX `fk_Giroscopio_Sensore1_idx` (`IDSensore` ASC),
...
CREATE TABLE IF NOT EXISTS `Temperatura` (
  ...
  `IDSensore` CHAR(5) NOT NULL,
  PRIMARY KEY (`TimeStamp`, `IDSensore`),
  INDEX `fk_Temperatura_Sensore1_idx` (`IDSensore` ASC),
...
CREATE TABLE IF NOT EXISTS `Posizione` (
  ...
  `IDSensore` CHAR(5) NOT NULL,
  PRIMARY KEY (`TimeStamp`, `IDSensore`),
  INDEX `fk_Posizione_Sensore1_idx` (`IDSensore` ASC),
...
CREATE TABLE IF NOT EXISTS `Pluviometro` (
  ...
  `IDSensore` CHAR(5) NOT NULL,
  PRIMARY KEY (`TimeStamp`, `IDSensore`),
  INDEX `fk_Pluviometro_Sensore1_idx` (`IDSensore` ASC),
...
CREATE TABLE IF NOT EXISTS `Alert` (
  ...
  `IDSensore` CHAR(5) NOT NULL,
  PRIMARY KEY (`TimeStamp`, `IDSensore`),
  INDEX `fk_Alert_Sensore1_idx` (`IDSensore` ASC),
...
CREATE TABLE IF NOT EXISTS `Materiale` (
  ...
  INDEX `fk_Materiale_Lavoro1_idx` (`CodLavoro` ASC),
  INDEX `fk_Materiale_Parte1_idx` (`Parte` ASC, `Vano` ASC, `Piano` ASC, `Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `Intonaco` (
  ...
  `NomeFornitore` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`CodLotto`, `NomeFornitore`),
  INDEX `fk_Intonaco_Materiale1_idx` (`CodLotto` ASC, `NomeFornitore` ASC),
...
CREATE TABLE IF NOT EXISTS `Mattone` (
  ...
  `NomeFornitore` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`CodLotto`, `NomeFornitore`),
  INDEX `fk_Mattone_Materiale1_idx` (`CodLotto` ASC, `NomeFornitore` ASC),
...
CREATE TABLE IF NOT EXISTS `Piastrella` (
  ...
  `NomeFornitore` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`CodLotto`, `NomeFornitore`),
  INDEX `fk_Piastrella_Materiale1_idx` (`CodLotto` ASC, `NomeFornitore` ASC),
...
CREATE TABLE IF NOT EXISTS `Altro` (
  ...
  `NomeFornitore` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`CodLotto`, `NomeFornitore`),
  INDEX `fk_Altro_Materiale1_idx` (`CodLotto` ASC, `NomeFornitore` ASC),
...
CREATE TABLE IF NOT EXISTS `Funzione` (
  ...
  INDEX `fk_Funzione_Vano1_idx` (`IDVano` ASC, `Piano` ASC, `Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `LavoriTurno` (
  ...
  `NumeroOre` INT NULL,
  `CodLavoro` CHAR(50) NULL,
  `Capo` CHAR(16) NULL,
  `Data` DATE NOT NULL,
  `CFiscLavoratore` CHAR(5) NOT NULL,
  `Orario` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`OraInizio`, `Data`, `CFiscLavoratore`, `Orario`),
  INDEX `fk_LavoriTurno_Turno1_idx` (`Data` ASC, `CFiscLavoratore` ASC, `Orario` ASC),
...
CREATE TABLE IF NOT EXISTS `Finestra` (
  ...
  INDEX `fk_Finestra_Vano1_idx` (`IDVano` ASC, `Piano` ASC, `Edificio` ASC),
...
CREATE TABLE IF NOT EXISTS `AccessoI` (
  ...
  INDEX `fk_PuntoAccessoInterno_has_Vano_Vano1_idx` (`IDVano` ASC, `Piano` ASC, `Edificio` ASC),
  INDEX `fk_PuntoAccessoInterno_has_Vano_PuntoAccessoInterno1_idx` (`IDPuntoAccesso` ASC),
